...
## Additional context for ODRL contracts

- Individuals' policies are modelled as `odrl:Set` since they represent the conditions of data use that any recipients of the policy must adhere to be able to use said data
...
**Add reference to ESWC2025 policy engine paper when available**
